...
def recognize_face(classifierModel,img,net):
    ...
    if persondict['confidence'] <= 28:
       persondict['name'] = "unknown"
       print "unknown detected"
       content = 'example email noti'
       gmailUser = 'dave.torrente@gmail.com'
       gmailPass = 'whaepekk'
       ...
       mail.login(gmailUser, gmailPass)

       mail.sendmail(gmailUser, 'eyeberrypicea2016@gmail.com', content)
